...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[#032f36] z-50 flex items-center justify-between px-4">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed left-0 top-0 bottom-0 w-[280px] bg-[#032f36] z-50 flex flex-col"
            >
      ...
      {/* Desktop Sidebar */}
      <div className={`hidden lg:flex flex-col fixed left-0 top-0 bottom-0 bg-[#032f36] z-40 transition-all duration-300 ${isSidebarCollapsed ? 'w-20' : 'w-64'}`}>
        {/* Logo */}
        <div className="flex items-center justify-between p-4 border-b border-white/10">
