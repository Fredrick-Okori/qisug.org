              ...
              {compulsoryCourses.map((course, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-lg truncate text-[#032f36]">
                      {course.name}
                    </h3>
                    <span className="bg-[#20cece] text-[#032f36] px-3 py-1 rounded-full text-sm">
              ...
              {pathways.map((pathway, index) => (
                ...
                >
                  <div className="w-16 h-16 bg-[#20cece] rounded-xl flex items-center justify-center mb-4">
                    <pathway.icon className="w-8 h-8 text-[#032f36]" />
                  </div>
                  <h3 className="text-2xl text-[#032f36] mb-3">
                    {pathway.title}
                  </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-start lg:items-center">
              ...
              <div className="order-2 lg:order-2">
                <motion.h2 
                  className="text-3xl lg:text-4xl text-[#032f36] mb-6"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                ...
                <div className="space-y-6">
                  <motion.div 
                    className="bg-gradient-to-r from-[#032f36]/10 to-transparent border-l-4 border-[#032f36] p-6 rounded-r-xl"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              <Link href="/admissions/apply-now">
                <Button
                  size="lg"
                  className="bg-[#20cece] text-[#032f36] hover:bg-[#20cece] px-8 py-6 rounded-full  transition-all duration-300"
                >
