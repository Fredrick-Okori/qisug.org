...
export default function DashboardPage() {
  ...
  const pendingCount = applications.filter(a => a.status === 'Under Review' || a.status === 'Submitted').length
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 transition-transform hover:scale-[1.02]">
          <div className="flex items-center gap-4">
