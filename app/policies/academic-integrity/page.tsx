            ...
            >
              <div className="bg-[#EFBF04] rounded-2xl p-8 lg:p-12 mb-8">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-12 h-12 bg-[#032f36] rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#EFBF04] rounded-xl p-6">
                  <h3 className="text-xl  text-[#032f36] mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#EFBF04] rounded-xl p-8">
                  <div className="flex items-center gap-3 mb-4">
                    <Users className="w-6 h-6 text-[#032f36]" />
                    <h3 className="text-2xl  text-[#032f36]">
                      Teacher
                    </h3>
                  </div>
                ...
                <div className="bg-[#EFBF04] rounded-xl p-8">
                  <div className="flex items-center gap-3 mb-4">
                    <Scale className="w-6 h-6 text-[#032f36]" />
                    <h3 className="text-2xl  text-[#032f36]">
                      Principal
                    </h3>
                  </div>
            ...
            >
              ...
              <div className="space-y-6">
                {consequences.map((consequence, index) => (
                  ...
                  >
                    <h4 className="text-2xl  text-[#032f36] mb-6">
                      {consequence.level}
                    </h4>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              <div className="bg-[#EFBF04] rounded-2xl p-8 lg:p-12">
                <div className="flex items-start gap-4 mb-6">
                  <BookOpen className="w-10 h-10 text-[#032f36] flex-shrink-0" />
                  <div>
                    <h2 className="text-3xl lg:text-4xl text-[#032f36]  mb-4">
                    ...
                    <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                      ...
                      <p className="font-medium text-[#032f36]">
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-[#EFBF04]/10 to-white border-2 border-[#EFBF04]/30 rounded-xl p-6 text-center">
                  <BookOpen className="w-10 h-10 text-[#032f36] mx-auto mb-4" />
                  ...
                  <a 
                    ...
                    className="text-[#032f36] hover:underline text-sm font-medium"
                  >
                    Read Document →
                  </a>
                </div>

                <div className="bg-gradient-to-br from-[#032f36]/10 to-white border-2 border-[#032f36]/30 rounded-xl p-6 text-center">
                  <Users className="w-10 h-10 text-[#032f36] mx-auto mb-4" />
                  <h3 className="text-lg  text-[#032f36] mb-2">
                    Student Support
                  </h3>
                  <p className="text-sm text-gray-600 mb-4">
                ...
                <div className="bg-gradient-to-br from-[#EFBF04]/10 to-white border-2 border-[#EFBF04]/30 rounded-xl p-6 text-center">
                  <FileText className="w-10 h-10 text-[#032f36] mx-auto mb-4" />
                  <h3 className="text-lg  text-[#032f36] mb-2">
                    All Policies
                  </h3>
                  <p className="text-sm text-gray-600 mb-4">
        ...
        <div className="bg-[#EFBF04] relative z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
            ...
            >
              ...
              <p className="text-lg text-[#032f36] mb-8 max-w-3xl mx-auto">
