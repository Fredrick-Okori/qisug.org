      ...
      <main className="flex-1 relative">
        ...
        <div className="pt-24 sm:pt-28 md:pt-40 lg:pt-50 xl:pt-48 pb-6 sm:pb-8 md:pb-10 lg:pb-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base text-[#032f36] mt-4 opacity-80">
        ...
        <div className=" relative bg-[#EFBF04] z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            ...
            >
              <h2 className="text-2xl lg:text-3xl text-[#032f36] mb-6 font-bold">
                Quick Navigation
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {sections.map((section, index) => (
                  <motion.a
                    key={section.id}
                    href={`#${section.id}`}
                    className="flex items-center gap-3 p-4 bg-gradient-to-br from-[#032f36] to-[#032f36] border-2 border-[#032f36] rounded-lg hover:border-[#032f36] hover:shadow-lg transition-all duration-300"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-[#032f36] rounded-lg flex items-center justify-center">
                  <Shield className="w-6 h-6 text-[#20cece]" />
                </div>
                <h2 className="text-3xl lg:text-4xl text-[#032f36] font-bold">
                  Introduction
                </h2>
              </div>
              <div className="space-y-4 text-[#032f36] text-base sm:text-lg leading-relaxed">
                <p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <div className="space-y-6 text-gray-700 text-base leading-relaxed">
                ...
                <div className="bg-gradient-to-r from-[#032f36]/10 to-transparent border-l-4 border-[#032f36] p-6 rounded-r-xl my-6">
                  <h3 className="text-xl font-bold text-[#032f36] mb-3 flex items-center gap-2">
        ...
        <div id="automatic-recording" className="bg-[#EFBF04] relative z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <div className="space-y-6 text-[#032f36] text-base leading-relaxed">
                <p>
                ...
                <div className=" p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-[#032f36] mb-3">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <div className="space-y-6 text-gray-700 text-base leading-relaxed">
                ...
                <h3 className="text-2xl font-bold text-[#032f36] mt-8 mb-4">
        ...
        <div id="student-photographs" className="bg-[#EFBF04] relative z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <div className="space-y-6 text-[#032f36] text-base leading-relaxed">
                <div className=" p-6 rounded-xl">
                  <p className="font-semibold text-lg mb-4 text-[#032f36]">
                ...
                <div className=" p-6 rounded-xl border-2 border-[#032f36]/20">
                  <div className="flex items-start gap-3">
                    <AlertCircle className="w-6 h-6 text-[#EFBF04] flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-semibold text-[#032f36] mb-2">
        ...
        <div id="contact" className=" relative z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#032f36] rounded-2xl mb-6">
              ...
              <div className="bg-gradient-to-br from-[#032f36] to-[#032f36] border-2 border-[#EFBF04]/30 rounded-2xl p-8 max-w-2xl mx-auto mb-8">
        ...
        <div className="bg-[#EFBF04] relative z-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
            ...
            >
              <Link 
                href="/policies"
                className="inline-flex items-center gap-2 text-[#032f36] hover:underline font-medium"
              >
