        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="space-y-1">
                {steps.map((step, index) => (
                  ...
                  >
                    <h3 
                      className="text-2xl  text-[#032f36] mb-2"
                      style={{ fontFamily: "'Crimson Pro', serif" }}
                    >
            ...
            <div className="flex flex-col gap-8 bg-[#efbf04]/20 p-6 rounded-xl">
              ...
              >
                <h2 
                  className="text-3xl  text-[#032f36] mb-6"
                  style={{ fontFamily: "'Crimson Pro', serif" }}
                >
                ...
                <div className="space-y-4">
                  {requiredDocs.map((doc, index) => (
                    ...
                    >
                      <h3 
                        className="text-xl  text-[#032f36] mb-2"
                        style={{ fontFamily: "'Crimson Pro', serif" }}
                      >
                        {doc.title}
                      </h3>
              ...
              <motion.div
                className="bg-gradient-to-br from-[#032f36] to-[#032f36] rounded-xl p-8 text-white"
                variants={fadeInVariants}
                initial="hidden"
                animate="visible"
                custom={0.8}
              ...
              >
                <h3 
                  className="text-2xl  text-[#032f36] mb-4"
                  style={{ fontFamily: "'Crimson Pro', serif" }}
                >
                  Apply Today
                </h3>
